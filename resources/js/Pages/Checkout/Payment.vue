            ...
            <div class="space-y-4">
                <div v-for="method in paymentMethods" :key="method.id" class="relative block cursor-pointer rounded-lg border bg-white p-5 shadow-sm focus:outline-none transition-all duration-200"
                    :class="{
                        ...
                        'border-[#040054] ring-1 ring-[#040054] bg-blue-50/20': form.payment_method === method.code && method.code !== 'whatsapp',
                    ...
                    <label class="flex items-center gap-4 cursor-pointer">
                        ...
                        <div class="flex-shrink-0" :class="form.payment_method === method.code ? (method.code === 'whatsapp' ? 'text-[#25D366]' : 'text-[#040054]') : 'text-gray-400'">
                        ...
                        <div class="w-6 h-6 rounded-full flex items-center justify-center border-2 transition-colors"
                            :class="form.payment_method === method.code 
                                ? (method.code === 'whatsapp' ? 'border-[#25D366] bg-[#25D366]' : 'border-[#040054] bg-[#040054]') 
                                : 'border-gray-300'">
