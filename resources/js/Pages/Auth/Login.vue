...
const submit = () => {
    // Inertia handles POST automatically
    // If error (422), Inertia populates form.errors
    // If success (302), Inertia redirects
    form.post(route('login'), {
        onFinish: () => form.reset('password'), // Clear password on finish
    });
};
</script>
            ...
            <div class="max-w-md w-full">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="mt-2 text-sm text-gray-600">
                        ¿No tienes cuenta?
                        <Link href="/register" class="font-medium text-[#F41D27] hover:underline">
                            Regístrate aquí
                        </Link>
                    </p>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-sm">
                                <a href="#" class="font-medium text-[#F41D27] hover:underline">
